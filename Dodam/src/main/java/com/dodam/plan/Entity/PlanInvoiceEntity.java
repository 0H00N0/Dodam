...
public class PlanInvoiceEntity {
  ...
  @Column(nullable=false) private LocalDateTime piStart;
  @Column(nullable=false) private LocalDateTime piEnd;

  @Column(nullable=false, precision=12, scale=2) private BigDecimal piAmount;
  @Column(nullable=false, length=3) private String piCurr = "KRW";

  @Enumerated(EnumType.STRING) @Column(nullable=false, length=20)
  private PiStatus piStat;

  @Column(length=200) private String piUid; // v2 paymentId
